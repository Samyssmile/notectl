...
const locale: ImageLocale = {
	...
	resizeHandleLabel: (position: string) => {
		...
		return `\u0418\u0437\u043c\u0435\u043d\u0438\u0442\u044c \u0440\u0430\u0437\u043c\u0435\u0440 ${positions[position] ?? position}`;
	},
	imageSelected:
		'\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e.',
	altTextPrefix: '\u0410\u043b\u044c\u0442. \u0442\u0435\u043a\u0441\u0442: ',
	imageSizeAnnounce: (w: number, h: number) =>
		`\u0420\u0430\u0437\u043c\u0435\u0440: ${w} \u043d\u0430 ${h} \u043f\u0438\u043a\u0441\u0435\u043b\u0435\u0439.`,
	resizeHint: (shrink: string, grow: string) =>
		`${shrink} / ${grow} \u0434\u043b\u044f \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u0440\u0430\u0437\u043c\u0435\u0440\u0430.`,
	imageResized: (w: number, h: number) =>
		`\u0420\u0430\u0437\u043c\u0435\u0440 \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u044f \u0438\u0437\u043c\u0435\u043d\u0451\u043d \u043d\u0430 ${w} \u043d\u0430 ${h} \u043f\u0438\u043a\u0441\u0435\u043b\u0435\u0439.`,
