...
notectl ships with 26 built-in plugins covering text formatting, headings, lists, tables, links, code blocks, images, fonts, text color, alignment, highlight, superscript/subscript, smart paste, RTL/bidi, and more. See the [Plugin Overview](/notectl/plugins/overview/) for the full list.
