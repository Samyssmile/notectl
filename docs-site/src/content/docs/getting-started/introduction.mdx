...
notectl ships with 23 built-in plugins covering text formatting, headings, lists, tables, links, code blocks, images, fonts, text color, alignment, highlight, superscript/subscript, smart paste, and more. See the [Plugin Overview](/notectl/plugins/overview/) for the full list.
