...
notectl ships with 15 built-in plugins covering text formatting, headings, lists, tables, links, fonts, text color, alignment, and more. See the [Plugin Overview](/notectl/plugins/overview/) for the full list.
