...
notectl ships with 22 built-in plugins covering text formatting, headings, lists, tables, links, code blocks, images, fonts, text color, alignment, highlight, superscript/subscript, and more. See the [Plugin Overview](/notectl/plugins/overview/) for the full list.
