...
<CardGrid stagger>
	<Card title="15 built-in plugins" icon="puzzle">
		Text formatting, headings, lists, tables, links, fonts, font sizes, text colors, alignment, blockquotes, strikethrough, horizontal rules, and a declarative toolbar. Every plugin ships with keyboard shortcuts, input rules, and accessible toolbar items.
	</Card>
...
<CardGrid>
	...
	<LinkCard title="Plugin Reference" href="/notectl/plugins/overview/" description="Browse all 15 built-in plugins with their APIs, commands, keyboard shortcuts, and screenshots." />
