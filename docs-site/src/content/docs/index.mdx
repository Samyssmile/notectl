...
<CardGrid stagger>
	<Card title="22 built-in plugins" icon="puzzle">
...
<CardGrid>
	...
	<LinkCard title="Plugin Reference" href="/notectl/plugins/overview/" description="Browse all 22 built-in plugins with their APIs, commands, keyboard shortcuts, and screenshots." />
